...
import { CalendarDaysIcon, ChevronRightIcon, ArrowRightIcon } from "@heroicons/react/24/outline"
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between p-6">
                <div className="flex flex-col items-center">
                    ...
                    <dt className="mt-4 font-semibold text-xl text-gray-900">Weekly articles</dt>
